...
* [Features Toggles](#features-toggles)
  ...
  * `NP_GOODIES_ARGUMENTS_USE_WCHAR` [➜](#arguments-parser---use-wchar_t-instead-of-char)
...
### Arguments Parser - Use wchar_t instead of char
**Definition:** `NP_GOODIES_ARGUMENTS_USE_WCHAR`

Changes all signatures and functions in the arguments parser to use `wchar_t` instead of `char`.

Transparent support can be achieved if you use the macros present in [arguments/macros.h](src/arguments/macros.h).
