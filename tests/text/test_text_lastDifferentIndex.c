...
int main(void) {
	...
	assert(text_lastDifferentIndex(TEXT("Hello world !   "), '\t') == 15,
	...
	// Edge-cases
	assert(text_lastDifferentIndex(TEXT(""), ' ') == 0,
